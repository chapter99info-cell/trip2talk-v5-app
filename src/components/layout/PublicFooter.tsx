      ...
      <div className="footer-wrapper relative z-[1] mx-auto grid max-w-[1150px] grid-cols-1 items-stretch gap-4 md:grid-cols-[minmax(0,350px)_1fr]">
        ...
        <div className="footer-left relative flex min-h-[340px] flex-col justify-between overflow-hidden rounded-[28px] bg-near-black-green p-8 shadow-[0_12px_40px_rgba(13,74,46,0.28)] max-md:min-h-0 max-md:gap-10">
          ...
          <div className="relative z-[1] flex flex-row items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg border-[1.5px] border-white/85 bg-white/15 font-sans text-base font-bold tracking-[-0.02em] text-white">
              T
            </div>
        ...
        <div className="footer-right relative flex flex-col justify-between overflow-visible rounded-[28px] bg-[#f0f1f5] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.04)] sm:p-10">
          ...
          >
            <div className="lucky-cube flex h-[72px] w-[72px] items-center justify-center rounded-[16px] sm:h-24 sm:w-24 sm:rounded-[22px]"
              style={{
                transform: 'rotate(-10deg)',
                background: 'linear-gradient(135deg, #d4a853 0%, #0d4a2e 55%, #13201a 100%)',
                boxShadow:
                  'inset 3px 3px 8px rgba(255,255,255,0.35), inset -3px -3px 12px rgba(0,0,0,0.18), 8px 14px 28px rgba(13,74,46,0.35)',
              }}
            >
              <span
                className="font-sans text-[32px] font-bold leading-none tracking-[-0.04em] text-white sm:text-[42px]"
                style={{
                  transform: 'rotate(10deg)',
